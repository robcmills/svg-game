...
export const isTimeTravelExpandedSelector = createSelector(
  hexViewSelector,
  (hexView) => hexView.isTimeTravelExpanded
)

export const isSettingsExpandedSelector = createSelector(
  hexViewSelector,
  (hexView) => hexView.isSettingsExpanded,
)
